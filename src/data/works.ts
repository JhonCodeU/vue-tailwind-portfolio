...
const works: Work[] = [
    {
        ...
        imgUrl: './works/work-5.png',
        images: ['./works/work-5.png', './works/work-4.png', './works/work-2.png'],
        url: 'https://github.com/JhonCodeU/App_gastos_React',
        tech: ['HTML', 'JavaScript', 'React', 'React-router', 'Redux', 'Firebase']
    },
    {
        id: 2,
